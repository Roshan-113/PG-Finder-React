@echo off
REM ========================================
REM PERSON 2: navaz05 (Collaborator)
REM ========================================

echo.
echo ========================================
echo PERSON 2: navaz05
...
git checkout -b navaz-day-%day_num%
...
if "%commit_msg%"=="" (
    set commit_msg=Update by navaz05 - Day %day_num%
)
...
git push origin navaz-day-%day_num%
...
echo.
echo NEXT STEP:
echo 1. Go to: https://github.com/navaz05/PG-Finder-React
